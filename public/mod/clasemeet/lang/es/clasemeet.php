...
$string['lastsync'] = 'Última comprobación en Google: {$a}';
...
$string['sync'] = 'Actualizar grabaciones y asistencia';
$string['tasksyncrecordings'] = 'Sincronizar grabaciones y asistencia de Clases Meet';
$string['watch'] = 'Ver';

// Asistencia desde Google Meet.
$string['attendance'] = 'Asistencia en Meet';
$string['attendanceapply'] = 'Registrar en Asistencia';
$string['attendanceapplyagain'] = 'Volver a calcular desde Meet';
$string['attendanceapplyagain_help'] = 'Recalcula las marcas que puso Clase Meet. Las que un docente cambió a mano (sin la nota [Meet]) no se modifican.';
$string['attendanceapplied'] = 'Asistencia registrada: {$a} estudiante(s) actualizados.';
$string['attendanceheading'] = 'Asistencia desde Google Meet';
$string['attendanceheading_desc'] = 'Clase Meet consulta quién entró a cada clase y, al terminar, marca Presente, Retraso o Falta en la actividad Asistencia del curso. Requiere el scope https://www.googleapis.com/auth/admin.directory.user.readonly en la delegación para identificar a cada participante por su correo.';
$string['attendancenoactivity'] = 'El curso no tiene una actividad Asistencia; la asistencia de Meet solo se muestra aquí.';
$string['attendancenotyet'] = 'La asistencia se registrará automáticamente en la actividad Asistencia unos 15 minutos después de que termine la clase.';
$string['attendancepending'] = 'Aún no se puede registrar: la clase no ha terminado, sigue alguien conectado o Google todavía no publicó los participantes.';
$string['attendancesessiondesc'] = 'Clase Meet: {$a}';
$string['attendancesync'] = 'Registrar la asistencia en la actividad Asistencia';
$string['attendancesync_desc'] = 'Al terminar cada clase se crea (o reutiliza) una sesión en la primera actividad Asistencia del curso y se marca a cada estudiante. Las marcas que un docente ya puso a mano no se cambian.';
$string['attendancetaken'] = 'Registrada en la actividad Asistencia el {$a}.';
$string['attendanceview'] = 'Abrir la sesión en Asistencia';
$string['connected'] = 'Conectado ahora';
$string['connections'] = 'Conexiones';
$string['email'] = 'Correo';
$string['firstjoin'] = 'Entrada';
$string['lastleave'] = 'Salida';
$string['latethreshold'] = 'Minutos de tolerancia';
$string['latethreshold_desc'] = 'Quien entra después de estos minutos desde el inicio programado se marca como Retraso.';
$string['minpercent'] = 'Permanencia mínima (%)';
$string['minpercent_desc'] = 'Porcentaje mínimo del horario de la clase que el estudiante debe estar conectado. Por debajo se marca como Falta.';
$string['moodleuser'] = 'Usuario de Aurora';
$string['noparticipants'] = 'Todavía no hay datos de asistencia. Google los publica unos minutos después de que alguien entra a la reunión.';
$string['notidentified'] = 'No identificado';
$string['notjoined'] = 'No entró';
$string['participanttype_anonymous'] = 'Invitado sin cuenta';
$string['participanttype_phone'] = 'Por teléfono';
$string['percent'] = 'Permanencia';
$string['privacy:metadata:clasemeet_participant'] = 'Participantes de las reuniones de Google Meet de cada clase, obtenidos de la API de Meet.';
$string['privacy:metadata:clasemeet_participant:displayname'] = 'Nombre con el que la persona apareció en la reunión.';
$string['privacy:metadata:clasemeet_participant:duration'] = 'Tiempo total conectado.';
$string['privacy:metadata:clasemeet_participant:email'] = 'Correo de Google Workspace de la persona.';
$string['privacy:metadata:clasemeet_participant:firstjoin'] = 'Hora en que entró por primera vez.';
$string['privacy:metadata:clasemeet_participant:lastleave'] = 'Hora en que salió por última vez.';
$string['privacy:metadata:clasemeet_participant:userid'] = 'Usuario de Moodle al que corresponde el participante.';
$string['remarkjoined'] = '{$a->minutes} min ({$a->percent} %), entró a las {$a->join}';
$string['remarknotjoined'] = 'no entró a la reunión';
$string['result'] = 'Resultado';
$string['result_absent'] = 'Falta';
$string['result_late'] = 'Retraso';
$string['result_present'] = 'Presente';
$string['time'] = 'Tiempo';
$string['attendancerules'] = 'Retraso si entra más de {$a->late} min después del inicio; Falta si está conectado menos del {$a->percent} % del horario.';
$string['directoryuser'] = 'Cuenta para consultar el directorio';
$string['directoryuser_desc'] = 'Cuenta de Google Workspace con la que se identifica a los participantes por su correo. Debe ser administradora (basta un rol con permiso de lectura de usuarios) o estar activado el uso compartido de contactos del directorio. Vacío: se usa la cuenta del docente.';
